...
const ConditionCard = ({ icon, text1, text2}) => {
    return <div className='bg-blanco flex flex-col justify-center items-center p-8 gap-4 rounded-md'>
        ...
        <h3 className="text-base font-semibold h-6 w-64 flex justify-center">{text1}</h3>
        <p className="text-sm w-64 h-16 leading-4 font-normal flex  text-center">{text2}</p>
    </div>
}
